  ...
  return (
    ...
    >
      <SelectPrimitive.Trigger
        className={cn(
          "flex w-full items-center justify-between rounded-md border border-paper-4 bg-paper-0 text-left font-sans text-ink-1 cursor-pointer transition-[border-color] duration-150 ease-pantry hover:border-ink-3 data-[state=open]:border-ink-1 data-disabled:cursor-not-allowed data-disabled:opacity-50 data-placeholder:text-ink-4",
      ...
      <SelectPrimitive.Portal>
        <SelectPrimitive.Content
          position="popper"
          sideOffset={4}
          className="z-50 w-(--radix-select-trigger-width) max-h-(--radix-select-content-available-height) overflow-hidden rounded-md border border-ink-1 bg-paper-0 p-1 shadow-[0_12px_32px_rgba(26,24,20,0.12)] animate-[pantry-pop_0.15s_var(--ease-pantry)]"
        >
