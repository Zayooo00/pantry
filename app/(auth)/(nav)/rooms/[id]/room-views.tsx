  ...
  return (
    <SelectPrimitive.Root value={value} onValueChange={onChange}>
      ...
      >
        ...
        {!isDefault && <span className="absolute top-1 right-1 size-1.5 rounded-full bg-ink-1" />}
      </SelectPrimitive.Trigger>
      <SelectPrimitive.Portal>
        <SelectPrimitive.Content
          ...
          align="end"
          sideOffset={4}
          className="z-50 max-h-(--radix-select-content-available-height) min-w-50 animate-[pantry-pop_0.15s_var(--ease-pantry)] overflow-hidden rounded-md border border-ink-1 bg-paper-0 p-1 shadow-[0_12px_32px_rgba(26,24,20,0.12)]"
        >
