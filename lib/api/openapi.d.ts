...
export interface components {
  schemas: {
    ...
    InviteMemberResponse:
      | components["schemas"]["InviteMemberAdded"]
      | components["schemas"]["InviteMemberPending"];
    InviteMemberRequest: {
      /** Format: email */
      email: string;
      /** @enum {string} */
    ...
    ShoppingPostRequest:
      | components["schemas"]["ManualShoppingRequest"]
      | components["schemas"]["FromItemShoppingRequest"];
